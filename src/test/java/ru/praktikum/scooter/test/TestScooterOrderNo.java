...
import org.openqa.selenium.support.ui.WebDriverWait;import ru.praktikum.scooter.test.pageobject.PageCreatedOrder;
...
public class TestScooterOrderNo extends BaseTestScooterOrder {
    ...
    @Test
       ...
       //Подождать
        ...
        pageCreatedOrder.clickConfirmOrderNo();
       var isOrderDisplayed3 = driver.findElement(By.xpath(".//div[contains(text(), 'Про аренду')]")).isDisplayed();
        assertTrue(isOrderDisplayed3);
    }
}
